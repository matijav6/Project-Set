...
{
    public partial class FormNovaFirmaNjem : Form
    {
        public FormNovaFirmaNjem()
        {
            InitializeComponent();
        ...
        public void SpremanjeFaktura()
        {
            ...
            if (textBoxRabat.Text.Length != 0)
                putanjaDoNoveFakture = Application.StartupPath + "\\Fakture\\NOVA_RABAT_NJEM.xlsx";

            else putanjaDoNoveFakture = Application.StartupPath + "\\Fakture\\NOVA_NJEM.xlsx";
            ...
            if (radioPlaceno.Checked == true || radioNePlaceno.Checked == true)
            {
               ...
               /* if(textBoxPozicija.Text.Length != 0)
                {
                    rowIndex = 22;
                    colIndex = 7;
                }*/
        ...
        private void FormNovaFirmaNjem_Load(object sender, EventArgs e)
        {
