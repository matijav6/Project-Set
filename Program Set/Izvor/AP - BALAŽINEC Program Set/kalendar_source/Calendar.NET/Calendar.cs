...
namespace Calendar.NET
{
    ...
    public class Calendar : UserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this._btnToday.ButtonText = "Danas";
        ...
        private void RenderMonthCalendar(PaintEventArgs e)
        {
            ...
            g.TextRenderingHint = System.Drawing.Text.TextRenderingHint.AntiAliasGridFit;
            SizeF sunSize = g.MeasureString("Ned", _dayOfWeekFont);
            SizeF monSize = g.MeasureString("Pon", _dayOfWeekFont);
            SizeF tueSize = g.MeasureString("Uto", _dayOfWeekFont);
            SizeF wedSize = g.MeasureString("Sri", _dayOfWeekFont);
            SizeF thuSize = g.MeasureString("Čet", _dayOfWeekFont);
            SizeF friSize = g.MeasureString("Pet", _dayOfWeekFont);
            SizeF satSize = g.MeasureString("Sub", _dayOfWeekFont);
            SizeF dateHeaderSize = g.MeasureString(
            ...
            DayOfWeek startWeekEnum = new DateTime(_calendarDate.Year, _calendarDate.Month, 7).DayOfWeek;
            ...
            xStart = MarginSize + ((cellWidth - (int)tueSize.Width) / 2) + cellWidth * 1;
            g.DrawString("Uto", _dayOfWeekFont, Brushes.Black, xStart, yStart);

            xStart = MarginSize + ((cellWidth - (int)wedSize.Width) / 2) + cellWidth * 2;
            g.DrawString("Sri", _dayOfWeekFont, Brushes.Black, xStart, yStart);

            xStart = MarginSize + ((cellWidth - (int)thuSize.Width) / 2) + cellWidth * 3;
            g.DrawString("Čet", _dayOfWeekFont, Brushes.Black, xStart, yStart);

            xStart = MarginSize + ((cellWidth - (int)friSize.Width) / 2) + cellWidth * 4;
            g.DrawString("Pet", _dayOfWeekFont, Brushes.Black, xStart, yStart);

            xStart = MarginSize + ((cellWidth - (int)satSize.Width) / 2) + cellWidth * 5;
            g.DrawString("Sub", _dayOfWeekFont, Brushes.Black, xStart, yStart);

            xStart = MarginSize + ((cellWidth - (int)sunSize.Width) / 2) + cellWidth * 6;
            g.DrawString("Ned", _dayOfWeekFont, Brushes.Black, xStart, yStart);
        ...
        private bool NeedsRendering(IEvent evnt, DateTime day)
        {
            ...
            if (evnt.RecurringFrequency == RecurringFrequencies.EveryWeekend && (day.DayOfWeek == DayOfWeek.Friday || day.DayOfWeek == DayOfWeek.Sunday))
                return DayForward(evnt, day);
